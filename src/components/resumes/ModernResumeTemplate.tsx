...
export const ModernResumeTemplate = forwardRef(
  ({ data }: ResumePreviewProps, ref: ForwardedRef<HTMLDivElement>) => {
    return (
      <div ref={ref} className="bg-white dark:bg-card shadow-lg rounded-lg overflow-hidden">
...
ModernResumeTemplate.displayName = 'ModernResumeTemplate';
